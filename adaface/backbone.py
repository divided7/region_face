...
def build_model(model_name='ir_50', size=112):
    if model_name == 'ir_101':
        return IR_101(input_size=(size, size))
    elif model_name == 'ir_50':
        return IR_50(input_size=(size, size))
    elif model_name == 'ir_se_50':
        return IR_SE_50(input_size=(size, size))
    elif model_name == 'ir_34':
        return IR_34(input_size=(size, size))
    elif model_name == 'ir_18':
        return IR_18(input_size=(size, size))
    else:
